...
import com.example.mercado.ListarProductos;
...
public class EditarProducto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DbArticulos dbArticulos = new DbArticulos(EditarProducto.this);
        articulos = dbArticulos.VerArticulos(id);

        if (articulos != null){

            byte[] imgProducto = articulos.getImagen();
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!txtNombreProd.getText().toString().equals("") && !txtPrecio.getText().toString().equals("")){
                    DbArticulos dbArticulos = new DbArticulos(EditarProducto.this);
                    long art = dbArticulos.EditarArticulo(txtCodBarra.getText().toString(), txtNombreProd.getText().toString(),txtPrecio.getText().toString(),ImageToByte(imgViewCambiarFoto),"1",id);
                    ...
                    Toast.makeText(EditarProducto.this, "DEBE LLENAR LOS CAPOS NOMBRE Y PRECIO",Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        imgViewCambiarFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    //Configuracion de cod.barra y permisos para camara y galeria
        ...
        if (resultCode == RESULT_OK){
            ...
            if(requestCode == IMAGE_PICK_GALLERY_CODE){
                ...
                if (resultCode == RESULT_OK){
                    ...
                    imageUri = resultUri;
                    //set Image
                    imgViewCambiarFoto.setImageURI(resultUri);
                }
   ...
   public byte[] ImageToByte(ImageView imgViewAgregarFoto) {
